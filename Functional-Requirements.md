...
## <span id="sumario">Sumário</span>
  ...
  - [4 - A aplicação deve ter o endpoint GET `/user/:id`](#4---a-aplicação-deve-ter-o-endpoint-get-userid)
  - [5 - A aplicação deve ter o endpoint POST `/categories`](#5---a-aplicação-deve-ter-o-endpoint-post-categories)
  - [6 - A aplicação deve ter o endpoint GET `/categories`](#6---a-aplicação-deve-ter-o-endpoint-get-categories)
  - [7 - A aplicação deve ter o endpoint POST `/post`](#7---a-aplicação-deve-ter-o-endpoint-post-post)
...
**[Validar que não é possível cadastrar usuário com o campo `displayName` menor que 8 caracteres]**
...
**[Validar que não é possível cadastrar usuário com o campo `password` diferente de 6 caracteres]**
...
**[Validar que o campo `password` é obrigatório]**
...
**[Validar que não é possível fazer login sem o campo `email`]**
...
**[Validar que não é possível fazer login sem o campo `password`]**
...
**[Validar que não é possível fazer login com o campo `email` em branco]**
...
**[Validar que não é possível fazer login com o campo `password` em branco]**
...
**[Validar que não é possível fazer login com um usuário que não existe]**
...
**[Validar que não é possível listar usuários sem o token na requisição]**

Se o token for inexistente o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![Token Vazio](./public/tokenvazio.png)

**[Validar que não é possível listar usuários com o token inválido]**
...
**[Validar que não é possível listar um usuário inexistente]**
...
**[Validar que não é possível listar um determinado usuário sem o token na requisição]**

Se o token for inexistente o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![Listar um usuário sem token](./public/semtokenumusuario.png)

**[Validar que não é possível listar um determinado usuário com o token inválido]**
...
**[Validar que não é possível cadastrar uma categoria sem o campo name]**
...
**[Validar que não é possível cadastrar uma determinada categoria com o token inválido]**

Se o token for inválido o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![Cadastrar uma categoria com token inválido](./public/cadastrarcategoriacomtokeninvalido.png)

**[Validar que não é possível cadastrar uma determinada categoria sem o token na requisição]**
...
**[Validar que não é possível listar as categorias com o token inválido]**
...
**[Validar que não é possível cadastrar um blogpost sem o campo `title`]**
...
**[Validar que não é possível cadastrar um blogpost sem o campo `content`]**
...
**[Validar que não é possível cadastrar um blogpost sem o campo `categoryIds`]**
...
**[Validar que não é possível cadastrar um blogpost com uma `categoryIds` inexistente]**
...
**[Validar que não é possível cadastrar um blogpost sem o token]**
...
**[Validar que não é possível cadastrar um blogpost com o token inválido]**
...
**[Validar que não é possível listar blogpost sem token]**

Se não conter o token o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![blogpost sem token ](./public/listarpostsemtoken.png)

**[Validar que não é possível listar blogpost com token inválido]**
...
**[Validar que não é possível listar um blogpost sem token]**

Se não conter o token o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![blogpost com token inválido](./public/listaumpostsemtoken.png)

**[Validar que não é possível listar um blogpost com token inválido]**

Se o token for inválido o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![blogpost com token inválido](./public/listaumposttokeninvalido.png)

**[Validar que não é possível listar um blogpost inexistente]**
...
**[Validar que não é possível editar as categorias de um blogpost]**
...
**[Validar que não é possível editar um blogpost com outro usuário]**

Somente o usuário que criou o post poderá edita-lo.

![blogpost com token inválido](./public/editarcomoutrousuario.png)

**[Validar que não possível editar um blogpost sem token]**

Se não conter o token o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![blogpost com token inválido](./public/editarsemtoken.png)

**[Validar que não possível editar um blogpost com token inválido]**

Se o token for inválido o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![blogpost com token inválido](./public/editartokeninvalido.png)

**[Validar que não possível editar um blogpost sem o campo `title`]**

Se não conter o campo `title` o resultado retornado deverá ser conforme exibido abaixo, com um status http `400`:

![blogpost com token inválido](./public/editarsemtitle.png)

**[Validar que não possível editar um blogpost sem o campo `content`]**
...
**[Validar que não é possível deletar um blogpost com outro usuário]**
...
**[Validar que não é possível deletar um blogpost inexistente]**
...
**[Validar que não é possível deletar um blogpost sem o token]**
...
**[Validar que não é possível deletar um blogpost com o token inválido]**
...
**[Validar que não é possivel excluir meu usuário com token inválido]**

Se o token for inválido o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![Deletar com token inválido](./public/deletarcomtokeninvalido.png)

**[Validar que não é possivel excluir meu usuário sem o token]**
...
**[Validar que é possível buscar um blogpost pelo `content`]**
...
**[Validar que é possível buscar todos os blogpost quando passa a busca vazia']**
...
**[Validar que é possível buscar um blogpost inexistente e retornar array vazio]**
...
**[Validar que não é possível buscar um blogpost sem o token]**

Se não contém o token o resultado retornado deverá ser conforme exibido abaixo, com um status http `401`:

![blogpost com token inválido](./public/buscarpostsemtoken.png)

**[Validar que não é possível buscar um blogpost com o token inválido]**
...
<a href="#sumario">Sumário</a> / <a href="https://github.com/becauro/blog_api/tree/main"> Página inicial </a>